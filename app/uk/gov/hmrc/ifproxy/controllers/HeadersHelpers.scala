...
trait HeadersHelpers {
  ...
  def toPrintableHeaders(headers: Map[String, Seq[String]]): String =
    toPrintableHeaders(headersMapToSeq(headers))

  def toPrintableHeaders(headers: Seq[(String, String)]): String =
